...
If (Round(GPUUtilisation/4) < 10) Then
	WScript.Echo "		<warning>1</warning>"
Else
	WScript.Echo "		<warning>0</warning>"
End If
WScript.Echo "		<float>0</float>"
WScript.Echo "		<LimitMinError>10</LimitMinError>"
WScript.Echo "		<LimitMinWarning>25</LimitMinWarning>"
...
If (Round(GPUTemperature/4) > 90) Then
	WScript.Echo "		<warning>1</warning>"
Else
	WScript.Echo "		<warning>0</warning>"
End If
...
If (Round(GPUPowerDraw/4) > 150) Then
	WScript.Echo "		<warning>1</warning>"
Else
	WScript.Echo "		<warning>0</warning>"
End If
WScript.Echo "		<float>1</float>"
WScript.Echo "		<LimitMaxError>150</LimitMaxError>"
...
WScript.Echo "		<warning>0</warning>"
WScript.Echo "		<float>0</float>"
WScript.Echo "		<LimitMinWarning>" & 1024*1024*32 & "</LimitMinWarning>"
